...
class MainViewModelTest {
    ...
    /**
     * a custom rule in this codebase that configures Dispatchers.Main
     * to use a TestCoroutineDispatcher from kotlinx-coroutines-test.
     *
     * This allows tests to advance a virtual-clock for testing,
